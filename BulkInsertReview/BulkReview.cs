...
namespace BulkInsertReview
{
    public class BulkReview
    {
            ...
            using (StreamReader sr = new StreamReader(filePath, Encoding.UTF8))
            {
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    if (!String.IsNullOrEmpty(fields[0].Trim()))
                    {
                        ...
                        student.MiddleName = fields[9];
                        student.LastName = fields[13];
        ...
        private void Insert(DataTable studentsTable, List<Student> students, SqlConnection conn, SqlTransaction tran)
        {
